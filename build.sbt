...
resolvers += Resolver.file("ivy-local", file("~/.ivy2"))
...
lazy val plugin = project
  ...
  .settings(
    Seq(
      ...
      // Snapshot for https://github.com/sbt/sbt2-compat/pull/15
      addSbtPlugin("com.github.sbt" % "sbt2-compat" % "0.1.0+21-f1eddbe1-SNAPSHOT"),
